...
`;
export const AppShell = ({ theme: t, appSlug, appTitle, navItems, user, logo, themeToggle, background, topBanner, apps = FLOWCORE_APPS, children, }) => {
    const [menuOpen, setMenuOpen] = useState(false);
    const defaultLogo = (_jsx("img", { src: "/flowcore-logo.svg", alt: "Flowcore", className: "appshell-logo" }));
    return (_jsxs("div", { style: { display: 'flex', height: '100vh', flexDirection: 'column', background: t.pageBg }, children: [_jsx("style", { children: APPSHELL_STYLES }), topBanner, _jsx(VersionBanner, {}), _jsxs("nav", { style: {
                    background: t.navBg,
